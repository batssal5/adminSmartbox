...
public class StrUtils {
    ...
    public static Float nvl(Float str, Float defaultStr) {
        return str == null || str == -9999 ? defaultStr : str ;
    }
    public static Double nvl(Double str, Double defaultStr) {
        return str == null || str == -9999 ? defaultStr : str ;
    }
    public static Integer nvl(Integer str, Integer defaultStr) {
        return str == null || str == -9999 ? defaultStr : str ;
    }
...
//		  	str = str.replaceAll("#"  , "&#35;");
    ...
    public static String getClientIp(HttpServletRequest request){
        String clientIp = StrUtils.nvl(request.getHeader("X-Forwarded-For"),"");
        if(clientIp == null || clientIp.length() == 0){
            clientIp = StrUtils.nvl(request.getHeader("WL-Proxy-Client-IP"),"");
        }
        if(clientIp == null || clientIp.length() == 0){
            clientIp = StrUtils.nvl(request.getHeader("Proxy-Client-IP"),"");
        }
        if(clientIp == null || clientIp.length() == 0){
