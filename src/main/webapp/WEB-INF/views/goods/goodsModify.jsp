	                    ...
	                    <div class="card shadow mb-4">
	                        <div class="card-body">
	                            <div class="table-responsive">
	                            	...
	                            	<input type="hidden" id="idx" name="idx" value="${goods.idx }">
	                                <table class="table table-bordered" id="inputTable" width="100%" cellspacing="0">
	                                    ...
	                                    <tbody>
	                                        ...
	                                        <tr>
	                                            <td>skuid</td>
	                                            <td><input type="text" id="skuid" name="skuid" style="width:100%;" value="${goods.skuid }"></td>
	                                            <td>바코드</td>
	                                            <td><input type="text" id="barcode" name="barcode" style="width:100%;" value="${goods.barcode }"></td>
	                                        </tr>
	                                        <tr>
	                                            <td>브랜드</td>
	                                            <td>
	                                            	<input type="hidden" id="brand" name="brand" value="${goods.brand }">
	                                            ...
	                                            <td>상품코드</td>
	                                            <td><input type="text" id="gcode" name="gcode" style="width:100%;" value="${goods.gcode }"></td>
	                                        </tr>
	                                        <tr>
	                                            <td>상품명</td>
	                                            <td><input type="text" id="name" name="name" style="width:100%;" value="${goods.name }"></td>
	                                            <td>기본가격</td>
	                                            <td><input type="text" id="price" name="price" style="width:100%;" value="${goods.price }"></td>
	                                        </tr>
	                                        <tr>
	                                        	<td>이미지</td>
	                                        	<td>
	                                        	...
	                                        	<td>메모</td>
	                                        	<td>
				                                    <input type="text" name="description" id="description" value="" style="width:100%;" value="${goods.description} ">
	                                        	</td>
	                                        </tr>
	                                    </tbody>
	                                </table>
